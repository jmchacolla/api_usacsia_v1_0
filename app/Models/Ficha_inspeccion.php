...
class Ficha_inspeccion extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['et_id', 'fun_id', 'cat_id', 'fi_fecha_asignacion', 'fi_fecha_realizacion', 'fi_observacion', 'fi_estado', 'fi_foco_insalubridad', 'fi_exibe_certificado', 'fi_exibe_carne', 'fi_extinguidor', 'fi_botiquin', 'created_at', 'updated_at', 'deleted_at', 'userid_at'];
